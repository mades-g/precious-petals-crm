...
export type CostumersResponse<Texpand = unknown> = Required<CostumersRecord> & BaseSystemFields<Texpand>
export type OrderFrameItemsResponse<Textras = unknown, Texpand = unknown> = Required<OrderFrameItemsRecord<Textras>> & BaseSystemFields<Texpand>
export type OrderPaperweightItemsResponse<Texpand = unknown> = Required<OrderPaperweightItemsRecord> & BaseSystemFields<Texpand>
